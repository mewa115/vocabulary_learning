...
def update_the_list_of_learning_words(df_select_currently_studying):
    ...
    print(indexes_of_available_to_learn_words)
...
update_the_list_of_learning_words(df_select_currently_studying)